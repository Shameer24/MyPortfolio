...
const Contact = () => {
  ...
  return (
    <Layout
      title="Mohamed Shameer contact page"
      desc="If you have questions or need help you can contact me at mohamedshameer2406@gmail.com | Or Send a Message through the form."
    >
      <Box
        sx={{
          overflowX: "hidden",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <ContactBox
                href="mailto:mohamedshameer2406@gmail.com"
                target="_blank"
                t1="Get in touch"
                t2="Email Address"
                t3="mohamedshameer2406@gmail.com"
              />
              <ContactBox
                href={`https://maps.app.goo.gl/xEECKQDGpnfVk5oPA`}
                target="_blank"
                t1="Location"
